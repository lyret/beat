...
import { BeatTokenizer, CollectionNode, ContstraintsNode, ReferenceNode, LeafNode, Node, EmptyNode, Metadata, NodeWithMetadata, ActionNode, InputNode } from './source';

//#region TOKENS

const Assignment = BeatTokenizer.createToken({ name: "Assignment", pattern: /\:/ }, { type: "keyword.control" });
const Tag = BeatTokenizer.createToken({ name: "Tag", pattern: /\#/ }, { type: "keyword.control" });
const Identifier = BeatTokenizer.createToken({ name: "Identifier", pattern: /[A-Za-z0-9]+/ }, { type: "constant" });
const Reference = BeatTokenizer.createToken({ name: "Reference", pattern: /[^\)]+/ });
const Comment = BeatTokenizer.createToken({ name: "Comment", pattern: /\/.*\//, group: Lexer.SKIPPED }, { type: "comment" });
const LeftBracket = BeatTokenizer.createToken({ name: "LeftBracket", pattern: /\[/ }, { type: "entity.name.tag" });
const RightBracket = BeatTokenizer.createToken({ name: "RightBracket", pattern: /\]/ }, { type: "entity.name.tag" });
const LeftCurlyBracket = BeatTokenizer.createToken({ name: "LeftCurlyBracket", pattern: /\{/, push_mode: "ruleMode" }, { type: "meta.tag" });
const RighCurlyBracket = BeatTokenizer.createToken({ name: "RighCurlyBracket", pattern: /\}/, pop_mode: true, }, { type: "meta.tag" });
const LeftReferenceBracket = BeatTokenizer.createToken({ name: "LeftReferenceBracket", pattern: /\(/, push_mode: "refMode" }, { type: "entity.name.tag" });
const RighReferenceBracket = BeatTokenizer.createToken({ name: "RighReferenceBracket", pattern: /\)/, pop_mode: true }, { type: "entity.name.tag" });
const Equals = BeatTokenizer.createToken({ name: "Equals", pattern: /\=/ }, { type: "keyword.control" })
const Optional = BeatTokenizer.createToken({ name: "Optional", pattern: /\?/ }, { type: "keyword.control" })
const Ellipsis = BeatTokenizer.createToken({ name: "Ellipsis", pattern: /\.\.\./ }, { type: "keyword.control" })
const Grid = BeatTokenizer.createToken({ name: "Grid", pattern: /\:\:/ }, { type: "keyword.control" })
const L = BeatTokenizer.createToken({ name: "L", pattern: /l/ }, { type: "keyword.control" })
const Input = BeatTokenizer.createToken({ name: "Input", pattern: /->/ }, { type: "support.variable" })
const Output = BeatTokenizer.createToken({ name: "Output", pattern: /=[>|=]/ }, { type: "support.variable" })
const Action = BeatTokenizer.createToken({ name: "Action", pattern: /@/ }, { type: "support.function" })
const StringType = BeatTokenizer.createToken({ name: "StringType", pattern: /string/ }, { type: "constant.language" })
const NumberType = BeatTokenizer.createToken({ name: "NumberType", pattern: /number/ }, { type: "constant.language" })
const BooleanType = BeatTokenizer.createToken({ name: "BooleanType", pattern: /bool/ }, { type: "constant.language" })
const AnyType = BeatTokenizer.createToken({ name: "AnyType", pattern: /any/ }, { type: "constant.language" })
